...
const char PROGMEM str_prog_name[]    = "\r\n>>>BASE TEMPLATE\r\n\r\nXMEGA32A4U RTC 1sec & _millis() & _micros() Timing 22/01/2015..\r\n"; // Program name
...
void RTC_RC32K_1SEC_INIT(void)
{
	...
	//RTC.PER = 4; //!! => RTC_OVF_vect при каждой единице счета 5sec
	//RTC.PER = 9; //!! => RTC_OVF_vect при каждой единице счета 10sec
